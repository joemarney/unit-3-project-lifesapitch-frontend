  ...
  return (
    <main className={styles.container}>
      ...
      <Link to="https://github.com/The-Mostest" className="github-link">
        <img src="/images/FinnMcDougall.png" alt="A photo of a bald man,standing in a pink jumper with his hands on his hips" />
      </Link>
      ...
      <Link to="https://github.com/joemarney" className="github-link">
        <img src="/images/JoeMarney.png" alt="A placeholder image of the silhouette of a figure" />
      </Link>
